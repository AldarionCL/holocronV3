...
export interface VisitorUser {
  ...
  level: number;
  faction: string;
  status: 'exploring' | 'trading' | 'in_combat' | 'idle';
}
...
// Usuarios visitantes por edificio (simulación de jugadores en línea)
export const buildingVisitors: { [buildingId: string]: VisitorUser[] } = {
  market1: [
    {
      id: 'b1',
      username: 'ShopaholicPilot',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ShopaholicPilot',
      level: 12,
      faction: 'Comerciantes',
      status: 'trading'
    },
    {
      id: 'b2',
      username: 'DealHunter',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=DealHunter',
      level: 18,
      faction: 'Neutral',
      status: 'trading'
    }
  ...
  hangar1: [
    {
      id: 'b3',
      username: 'MechanicGenius',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=MechanicGenius',
      level: 20,
      faction: 'Comerciantes',
      status: 'trading'
    },
    {
      id: 'b4',
      username: 'ShipCollector',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ShipCollector',
      level: 25,
      faction: 'Neutral',
      status: 'exploring'
    }
  ...
  factory1: [
    {
      id: 'b5',
      username: 'IndustrialWorker',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=IndustrialWorker',
      level: 15,
      faction: 'Comerciantes',
      status: 'trading'
    }
  ...
  barracks1: [
    {
      id: 'b6',
      username: 'EliteGuard',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=EliteGuard',
      level: 28,
      faction: 'Imperio',
      status: 'idle'
    },
    {
      id: 'b7',
      username: 'RecruitTrainer',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=RecruitTrainer',
      level: 22,
      faction: 'Imperio',
      status: 'exploring'
    },
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=WeaponMaster',
      level: 30,
      faction: 'Imperio',
      status: 'in_combat'
    }
  ...
  lab1: [
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=QuantumPhysicist',
      level: 19,
      faction: 'Jedi',
      status: 'exploring'
    },
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ResearchAssistant',
      level: 14,
      faction: 'Neutral',
      status: 'exploring'
    }
  ...
  hall1: [
    {
      id: 'b11',
      username: 'Ambassador',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Ambassador',
      level: 23,
      faction: 'Jedi',
      status: 'exploring'
    },
    {
      id: 'b12',
      username: 'CouncilMember',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=CouncilMember',
      level: 26,
      faction: 'Comerciantes',
      status: 'idle'
    }
  ...
  chamber1: [
    {
      id: 'b13',
      username: 'SithApprentice',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=SithApprentice',
      level: 33,
      faction: 'Imperio',
      status: 'idle'
    },
    {
      id: 'b14',
      username: 'ImperialAdvisor',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ImperialAdvisor',
      level: 38,
      faction: 'Imperio',
      status: 'exploring'
    }
...
// Usuarios visitantes por sector (simulación de jugadores en línea)
export const sectorVisitors: { [sectorId: string]: VisitorUser[] } = {
  commercial1: [
    {
      id: 'u1',
      username: 'SpaceTrader42',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=SpaceTrader42',
      level: 15,
      faction: 'Comerciantes',
      status: 'trading'
    },
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=GalaxyExplorer',
      level: 8,
      faction: 'Jedi',
      status: 'exploring'
    },
    {
      id: 'u3',
      username: 'StellarMerchant',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=StellarMerchant',
      level: 22,
      faction: 'Comerciantes',
      status: 'trading'
    },
    {
      id: 'u4',
      username: 'NovaSeeker',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=NovaSeeker',
      level: 11,
      faction: 'Neutral',
      status: 'idle'
    }
  ...
  industrial1: [
    {
      id: 'u5',
      username: 'ForgeWorker99',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ForgeWorker99',
      level: 18,
      faction: 'Comerciantes',
      status: 'trading'
    },
    {
      id: 'u6',
      username: 'MechEngineer',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=MechEngineer',
      level: 25,
      faction: 'Neutral',
      status: 'exploring'
    },
    {
      id: 'u7',
      username: 'SteelCaptain',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=SteelCaptain',
      level: 13,
      faction: 'Comerciantes',
      status: 'idle'
    }
  ...
  residential1: [
    {
      id: 'u8',
      username: 'PeacefulPilot',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=PeacefulPilot',
      level: 6,
      faction: 'Jedi',
      status: 'idle'
    },
    {
      id: 'u9',
      username: 'HomeSeeker',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=HomeSeeker',
      level: 9,
      faction: 'Neutral',
      status: 'exploring'
    }
  ...
  military1: [
    {
      id: 'u10',
      username: 'WarriorX',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=WarriorX',
      level: 30,
      faction: 'Imperio',
      status: 'in_combat'
    },
    {
      id: 'u11',
      username: 'CommanderStrike',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=CommanderStrike',
      level: 27,
      faction: 'Imperio',
      status: 'in_combat'
    },
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=TacticalFox',
      level: 24,
      faction: 'Rebeldes',
      status: 'in_combat'
    },
    {
      id: 'u13',
      username: 'BattleStar',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=BattleStar',
      level: 19,
      faction: 'Imperio',
      status: 'exploring'
    },
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ShadowAssassin',
      level: 28,
      faction: 'Neutral',
      status: 'idle'
    }
  ...
  research1: [
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ScienceNerd',
      level: 17,
      faction: 'Jedi',
      status: 'exploring'
    },
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=DataCollector',
      level: 14,
      faction: 'Neutral',
      status: 'trading'
    }
  ...
  palace1: [
    {
      id: 'u17',
      username: 'DiplomatPro',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=DiplomatPro',
      level: 21,
      faction: 'Jedi',
      status: 'exploring'
    },
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=NobleVisitor',
      level: 16,
      faction: 'Comerciantes',
      status: 'idle'
    },
    {
      id: 'u19',
      username: 'RoyalGuest',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=RoyalGuest',
      level: 20,
      faction: 'Neutral',
      status: 'exploring'
    }
  ...
  throne1: [
    {
      id: 'u20',
      username: 'ImperialLord',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ImperialLord',
      level: 35,
      faction: 'Imperio',
      status: 'idle'
    },
    {
      id: 'u21',
      username: 'DarkSithLord',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=DarkSithLord',
      level: 40,
      faction: 'Imperio',
      status: 'in_combat'
    },
    {
      id: 'u22',
      username: 'EmpireGeneral',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=EmpireGeneral',
      level: 32,
      faction: 'Imperio',
      status: 'exploring'
    }
