...
import { buildings, npcs, sectors, buildingVisitors } from "../data/gameData";
...
export default function BuildingView() {
  ...
  const visitors = buildingVisitors[buildingId || ""] || [];
  ...
  return (
    <div className="relative size-full overflow-hidden">
      ...
      {/* Panel de visitantes */}
      <VisitorsPanel visitors={visitors} sectorName={building.name} />
    </div>
  );
}